...
async function loadPlaywrightChecks(playwrightChecks, playwrightConfigPath, include) {
    ...
    if (playwrightChecks?.length) {
        for (const playwrightCheckProps of playwrightChecks) {
            ...
            const { key, browsers, relativePlaywrightConfigPath, cacheHash, } = await playwright_check_1.PlaywrightCheck.bundleProject(playwrightConfigPath, include ?? []);
        ...
        const { key, browsers, relativePlaywrightConfigPath, cacheHash, } = await playwright_check_1.PlaywrightCheck.bundleProject(playwrightConfigPath, include ?? []);
        const playwrightCheck = new playwright_check_1.PlaywrightCheck(path.basename(playwrightConfigPath), {
